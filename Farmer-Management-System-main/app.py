...
def farm():
    ...
    if user_id is not None:
        ...
        # If you have a specific reason for the popitem loop, keep it. Otherwise, you can remove it.
        for d in info:
            _ = d.popitem()
        if len(info) == 0:
            msg = "Sorry, no data found!!!"
        data = {'user_id': user_id, 'msg': msg, 'info': info}
...
def crop_allocation():
    ...
    if user_id is not None:
        cursor = mysql.connection.cursor(MySQLdb.cursors.DictCursor) 
        cursor.execute('SELECT * FROM crop_allocation WHERE User_id = %s ', (user_id,))
        info = cursor.fetchall()
        # If you have a specific reason for the popitem loop, keep it. Otherwise, you can remove it.
        for d in info:
            _ = d.popitem()
...
def seed():
    ...
    if user_id is not None:
        cursor = mysql.connection.cursor(MySQLdb.cursors.DictCursor) 
        cursor.execute('SELECT * FROM seed WHERE User_id = %s ', (user_id,))
        info = cursor.fetchall()
        # If you have a specific reason for the popitem loop, keep it. Otherwise, you can remove it.
        for d in info:
            _ = d.popitem()
...
def pesticide():
    ...
    if user_id is not None:
        cursor = mysql.connection.cursor(MySQLdb.cursors.DictCursor) 
        cursor.execute('SELECT * FROM pesticide WHERE User_id = %s ', (user_id,))
        info = cursor.fetchall()
        # If you have a specific reason for the popitem loop, keep it. Otherwise, you can remove it.
        for d in info:
            _ = d.popitem()
...
def fertilizer():
    ...
    if user_id is not None:
        cursor = mysql.connection.cursor(MySQLdb.cursors.DictCursor) 
        cursor.execute('SELECT * FROM fertilizer WHERE User_id = %s ', (user_id,))
        info = cursor.fetchall()
        # If you have a specific reason for the popitem loop, keep it. Otherwise, you can remove it.
        for d in info:
            _ = d.popitem()
...
def labour():
    ...
    if user_id is not None:
        cursor = mysql.connection.cursor(MySQLdb.cursors.DictCursor) 
        cursor.execute('SELECT * FROM labour WHERE User_id = %s ', (user_id,))
        info = cursor.fetchall()
        # If you have a specific reason for the popitem loop, keep it. Otherwise, you can remove it.
        for d in info:
            _ = d.popitem()
...
def warehouse():
    ...
    if user_id is not None:
        cursor = mysql.connection.cursor(MySQLdb.cursors.DictCursor) 
        cursor.execute('SELECT * FROM warehouse WHERE User_id = %s ', (user_id,))
        info = cursor.fetchall()
        # If you have a specific reason for the popitem loop, keep it. Otherwise, you can remove it.
        for d in info:
            _ = d.popitem()
...
def crop_market():
    ...
    if user_id is not None:
        cursor = mysql.connection.cursor(MySQLdb.cursors.DictCursor) 
        cursor.execute('SELECT * FROM crop_market WHERE User_id = %s ', (user_id,))
        info = cursor.fetchall()
        for d in info:
            _ = d.popitem()
        if len(info) == 0:
        ...
        # Handle the case where 'id' is not in the session.
        return redirect(url_for('login'))
